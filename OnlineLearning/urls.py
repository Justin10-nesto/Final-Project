...
urlpatterns = [
    ...
    path('BooksEdit/<str:sid>/<str:tid>/<str:bid>', views.BooksEdit, name ='BooksEdit'),
    ...
    path('resubmit/<str:sid>/<str:tid>/<str:aid>', views.resubmit, name = 'resubmit'),
    ...
    path('Draft_add/<str:sid>/<str:tid>', views.Draft_add, name="Draft_add"),
